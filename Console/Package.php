...
file_put_contents($corePath . 'hHttp.php', php_strip_whitespace(__DIR__ . DIRECTORY_SEPARATOR));
file_put_contents($corePath . 'hExternal.php', php_strip_whitespace(__DIR__ . DIRECTORY_SEPARATOR));
