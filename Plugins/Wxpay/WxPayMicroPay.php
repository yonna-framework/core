...
class WxPayMicroPay extends AbstractLib{
	...
	{
		//①、提交被扫支付
		$result = $this->getWxPayApi()->micropay($microPayInput, 5);
		//如果返回成功
	 ...
	 * @return bool 0 订单不成功，1表示订单成功，2表示继续等待
	 * @throws WxPayException
	 */
	public function query($out_trade_no, &$succCode)
	{
		...
		$result = $this->getWxPayApi()->orderQuery($queryOrderInput);
	...
	public function cancel($out_trade_no, $depth = 0)
	{
		...
		$result = $this->getWxPayApi()->reverse($clostOrder);
